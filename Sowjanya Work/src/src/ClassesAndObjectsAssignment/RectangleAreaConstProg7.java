...
public class RectangleAreaConstProg7 {
    private int length;
    private int breadth;

    public RectangleAreaConstProg7(int length, int breadth) {
        this.length = length;
    ...
    public static void main(String[] args) {
        ...
        while(true) {
            ...
            RectangleAreaConstProg7 rectangle = new RectangleAreaConstProg7(length, breadth);
