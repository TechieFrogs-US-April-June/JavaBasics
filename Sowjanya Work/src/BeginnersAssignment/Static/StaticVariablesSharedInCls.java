...
public class StaticVariablesSharedInCls {
    static int var1=77;
    ...
    {
        StaticVariablesSharedInCls ob1 = new StaticVariablesSharedInCls();
        StaticVariablesSharedInCls ob2 = new StaticVariablesSharedInCls();
